...
**Last response summary:** All tests are passing across all packages. Here's a summary of what's in this repository:

## Attractor — DOT-based AI Pipeline Runner

This is a monorepo (`pnpm`/`npm` workspaces) with **4 packages**
